            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="caption-img text-right">
                        <img src="/front/images/watch-7.png" class="img-fluid animation-jump" alt>
                    </div>
                </div>
                <!--end caption image-->
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="about-img text-center">
                        <img src="/front/images/watch-8.png" class="img-fluid animation-jump" alt="Image">
                    </div>
                </div>
                <!--end about image-->
                <!--start about info-->
            ...
            <div class="row">
                ...
                <div class="col-lg-5 col-md-6">
                    <div class="product-gallery owl-carousel">
                        <img src="/front/images/watch-14.png" class="img-fluid" alt>
                        <img src="/front/images/watch-15.png" class="img-fluid" alt>
                        <img src="/front/images/watch-12.png" class="img-fluid" alt>
                    </div>
                </div>
                <!--end product gallery-->
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="product-single row">
                        ...
                        <img src="/front/images/{{$products->image_name}}" class="img-fluid" alt="Image">
                        </div>
                        <div class="product-cont col-lg-6">
                            <h4>{{$products->name}}</h4>
                            {{$products->description}}
                            <h3>${{$products->sale_price}} <del><sup>${{$products->price}}</sup></del></h3>
                        <add-to-cart :product="{{$products}}"></add-to-cart>
                        </div>
                    </div>
                </div>
                <!--end product single-->
        ...
        <div class="container">
            ...
            <div class="testi-carousel owl-carousel">
                ...
                <div class="testi-single text-center">
                    <div class="client-info">
                        <div class="client-img">
                            <img src="/front/images/client-1.jpg" class="img-fluid" alt>
                        </div>
                ...
                <div class="testi-single text-center">
                    <div class="client-info">
                        <div class="client-img">
                            <img src="/front/images/client-2.jpg" class="img-fluid" alt>
                        </div>
                        <div class="client-details">
                            <h4>Andrew Watt</h4>
                ...
                <div class="testi-single text-center">
                    <div class="client-info">
                        <div class="client-img">
                            <img src="/front/images/client-3.jpg" class="img-fluid" alt>
                        </div>
                        <div class="client-details">
                            <h4>Emma Dee</h4>
                            <p>App Developer</p>
                ...
                <div class="testi-single text-center">
                    <div class="client-info">
                        <div class="client-img">
                            <img src="/front/images/client-4.jpg" class="img-fluid" alt>
                        </div>
                        <div class="client-details">
                            <h4>Olivia Smith</h4>
                            <p>Web Developer</p>
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="contact-img text-center">
                        <img src="/front/images/watch-10.png" class="img-fluid animation-jump" alt>
                    </div>
                </div>
                <!--end contact image-->
            </div>
